...
<!-- Mirrored from themesbrand.com/velzon/html/master/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Jul 2024 15:23:35 GMT -->
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{asset('assets/images/favicon.ico') }}"> <!-- asset(...) là folder public -->
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="auth-logout-basic.html"><i class=""></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
{{-- {{ route('admin.logout')}} --}}
                    </div>
                </div>
            </div>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarDashboards">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('product.index')}}" class="nav-link" data-key="t-crm"> Danh Sách Sản Phẩm </a>
                                    </li>
                                </ul>
                            </div>
                        </li> <!-- end Sản Phẩm Menu -->
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                                <i class="ri-apps-2-line"></i> <span data-key="t-apps">Danh Mục Sản Phẩm</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{route('category.create')}}" class="nav-link" data-key="t-chat"> Thêm Danh Mục </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('category.index')}}" class="nav-link"> <span data-key="t-file-manager">Danh Sách Danh Mục </span></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                                <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Biến Thể Sản Phẩm</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarLayouts">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{route('variant.index')}}"  class="nav-link" data-key="t-detached">Danh sách Biến Thể</a>
                                    </li>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-title"><i class="ri-more-fill"></i> <span data-key="t-pages">BANNER</span></li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarAuth">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{route('banner.index')}}" class="nav-link"  role="button" aria-expanded="false" > Danh Sách Banner</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('banner.create')}}" class="nav-link"  role="button" aria-expanded="false" > Thêm Banner</a>
                                    </li>
                                </ul>
                            </div>
                        </li>

                        <li class="menu-title"><i class="ri-more-fill"></i> <span data-key="t-pages">KHUYẾN MÃI</span></li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarPages" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPages">
                                <i class="ri-pages-line"></i> <span data-key="t-pages">khuyến Mãi</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarPages">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{route('coupon.create')}}" class="nav-link" data-key="t-starter"> Thêm khuyến mãi </a>
                                    </li>
                                    
                                    <li class="nav-item">
                                        <a href="{{route('coupon.index')}}" class="nav-link" data-key="t-team"> Danh sách khuyến mãi </a>
                                    </li>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme01">
                                    <img src="{{asset('assets/images/demo/default.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme02">
                                    <img src="{{asset('assets/images/demo/saas.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme03">
                                    <img src="{{asset('assets/images/demo/corporate.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme04">
                                    <img src="{{asset('assets/images/demo/galaxy.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme05">
                                    <img src="{{asset('assets/images/demo/material.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme06">
                                    <img src="{{asset('assets/images/demo/creative.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme07">
                                    <img src="{{asset('assets/images/demo/minimal.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme08">
                                    <img src="{{asset('assets/images/demo/modern.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme09">
                                    <img src="{{asset('assets/images/demo/interactive.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme10">
                                    <img src="{{asset('assets/images/demo/classic.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme11">
                                    <img src="{{asset('assets/images/demo/vintage.png') }}" alt="" class="img-fluid">
                                </label>
                            </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/master/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Jul 2024 15:23:41 GMT -->
</html>
