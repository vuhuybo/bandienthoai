...
<!-- Mirrored from themesbrand.com/velzon/html/master/auth-signin-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Jul 2024 15:24:53 GMT -->
<head>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                            <form action="{{route('admin.loginad')}}">
                                                @csrf
                                                <div class="mb-3">
